...
import AddDocumentModal from '../documents/SendDocTostudent';
import ShowDocStudent from '../documents/ShowDocStudent';
import SendDocTostudent from '../documents/SendDocTostudent';
                            ...
                            <div className='row'>
                                ...
                                <div className='col-2'>
                                    ...
                                    <NavDropdown eventKey={3}
                                        ...
                                        title={
                                            <Img src={generate} alt="UserName profile image" style={{ width: '40px' }} />
                                        } >
                                        <NavDropdown.Item eventKey="2">
                                            <Link to={`/admin/SendDocTostudent/${item.id}`}>
                                                Ajouter un document à {item.name}
                                            </Link>
                                        </NavDropdown.Item>
                                        <NavDropdown.Item as={Link} to={`/admin/docs_to_student/${item.id}/${item.name}`} eventKey="1">
                                            List documents
                                        </NavDropdown.Item>
