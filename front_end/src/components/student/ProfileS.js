                    ...
                    <div className="card h-100">
                        <div className="card-body">
                            <div className="row gutters" style={{ marginTop: '50px' }}>
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12" style={{ marginTop: '10px' }}>
                                    <div className="form-group">
                                        <label >Filière</label>
                                        <input type="text" className="form-control" id="fullName" value={admin.sector} readOnly />
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12" style={{ marginTop: '10px' }}>
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" id="fullName" value={admin.level} readOnly />
                                    </div>
                                </div>
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12" style={{ marginTop: '10px' }}>
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" id="fullName" value={admin.stage_status} readOnly />
                                    </div>
                                </div>
                                <br />
                                ...
                                <div className="card-body" id='test2'>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="input-group input-group-merge">
                                            ...
                                            <input onChange={handlInputAdmin} type="text" className="form-control" id="sector" name="sector" value={admin.sector} />
                                        ...
                                        <div className="input-group input-group-merge">
                                            ...
                                            <input onChange={handlInputAdmin} type="text" className="form-control" id="level" name="level" value={admin.level} />
