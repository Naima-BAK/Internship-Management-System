                            ...
                            <div className="row gutters" style={{ marginTop: '50px' }}>
                                ...
                                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12" style={{ marginTop: '10px' }}>
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" id="fullName" value={admin.job} readOnly />
                                    </div>
                                </div>
                                ...
                                <div className="card-body" id='test2'>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="input-group input-group-merge">
                                            ...
                                            <input onChange={handlInputAdmin} type="text" className="form-control" id="job" name="job" value={admin.job} />
