...
function NavbarT() {
            ...
            <ul className="navbar-nav">
                ...
                <li className="nav-item">
                    <Dropdown>
                        ...
                        <Dropdown.Menu>
                            <Dropdown.Item eventKey=""></Dropdown.Item>
                            <Dropdown.Item as={Link} to="/teacher/setting" eventKey="option1">Paramétres</Dropdown.Item>
                            <Dropdown.Item as={Link} to="/teacher/profile" eventKey="option2"> Profile </Dropdown.Item>

                            <Dropdown.Divider />
                            <Dropdown.Item as={Link} to="/teacher/UpdatePassword" eventKey="option3">Modifier le mot de passe</Dropdown.Item>
    ...
    return (
        <nav style={{ backgroundColor: '#f8f9fa !important' }} className="sb-topnav navbar navbar-expand navbar-dark">
            ...
            <Link className="navbar-brand ps-3" to="/teacher" style={{ color: colors.sidebarecolor }}>
                Teacher dahboard
            </Link>
            &nbsp;&nbsp;&nbsp;
