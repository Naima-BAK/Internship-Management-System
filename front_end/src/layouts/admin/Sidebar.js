...
import BasicExample from '../../components/frontend/BasicExample';
        ...
        <nav className="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div className="sb-sidenav-menu">
                <div className="nav">
                    ...
                    {/* Dashboard---------------- */}
                    <Link className="nav-link" to="/admin/dashboard" style={{ marginBottom: '10px' }}>
                        <div className="sb-nav-link-icon">
                            <img className='img' width={20} src={dashboard} alt="logo" />
                        </div>
                        Dashboard
                    </Link>
                    ...
                    <Link className="nav-link" to="/admin/ListDocument">
                        <div className="sb-nav-link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#58D3F7" class="bi bi-file-earmark-richtext" viewBox="0 0 16 16">
                    ...
                    <Link className="nav-link" to="/admin/profile">
                        <div className="sb-nav-link-icon" style={{ marginBottom: '10px' }}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#58D3F7" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                    ...
                    <Link className="nav-link collapsed" to="/admin/ListTeacher" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                        <div className="sb-nav-link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#58D3F7" class="bi bi-person-video3" viewBox="0 0 16 16">
                    ...
                    <div className="collapse" id="collapseLayouts" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                        <nav className="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                            <Link className="nav-link collapsed" to="/admin/ListTeacher">
                                <div className="sb-nav-link-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="white" class="bi bi-circle-fill" viewBox="0 0 16 16">
                    ...
                    <Link className="nav-link collapsed" to="/admin/ListStudent" data-bs-toggle="collapse" data-bs-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                        <div className="sb-nav-link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#58D3F7" class="bi bi-mortarboard" viewBox="0 0 16 16">
                    ...
                    <Link className="nav-link collapsed" to="/admin/ListInternship" data-bs-toggle="collapse" data-bs-target="#stage" aria-expanded="false" aria-controls="collapseLayouts">
                        <div className="sb-nav-link-icon">
                            <img className='img' width={23} src={intern} alt="logo" />
                        </div>
                        Stages
                        <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-down"></i></div>
                    </Link>
                    ...
                    <Link className="nav-link collapsed" to="/admin/ListCompanies" data-bs-toggle="collapse" data-bs-target="#company" aria-expanded="false" aria-controls="collapseLayouts">
                        <div className="sb-nav-link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#58D3F7" class="bi bi-building" viewBox="0 0 16 16">
